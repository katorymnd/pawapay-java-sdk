...
public class ApiClient {
    ...
    private CompletableFuture<Void> initializeLicense(String licenseKey) {
        return CompletableFuture.runAsync(() -> {
            try {
                ...
                // Step 4: Server validation + domain activation
                ...
                // Warn if license expiring soon (simulated check based on local check output if provided)
    ...
    private CompletableFuture<Map<String, Object>> makeApiRequest(String endpoint, String method, Object data) {
        ...
        if (!isInitializing && !licenseValid) {
        ...
        return httpClient.sendAsync(requestBuilder.build(), HttpResponse.BodyHandlers.ofString())
                .thenApply(response -> {
                    ...
                    try {
                        ...
                        // FIXED: Use Object.class so Jackson can dynamically return a Map or a List
